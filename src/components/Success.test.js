...
//     expect(db.doc).toHaveBeenNthCalledWith(1, 'Products/123');
//     expect(db.doc).toHaveBeenNthCalledWith(2, 'Products/456');
//     expect(db.doc().data).toHaveBeenCalledTimes(2);
//     expect(db.doc().data).toHaveBeenNthCalledWith(1);
//     expect(db.doc().data).toHaveBeenNthCalledWith(2);
//     expect(db.updateDoc).toHaveBeenCalledTimes(2);
//   });
// });